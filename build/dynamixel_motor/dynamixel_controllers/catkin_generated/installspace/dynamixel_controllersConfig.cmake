...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'dynamixel_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/candyPicker_ws/install/${idir}'.  Ask the maintainer 'Antons Rebguns <arebgun@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/candyPicker_ws/install/lib;/home/ubuntu/candyPicker_ws/devel/lib;/home/ubuntu/catkin_ws/devel/lib;/opt/ros/hydro/lib)
